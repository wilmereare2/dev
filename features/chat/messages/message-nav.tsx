...
export function MessageNav({ filter, onFilterChange, layout = "sidebar", className, style }: MessageNavProps) {
  if (layout === "tabs") {
    return (
  ...
  return (
    <nav
      aria-label="Messages"
      style={style}
      className={cn("flex shrink-0 flex-col border-r border-border/60 bg-background/30", className)}
    >
